...
class HBV
{
 public:
  ...
  void WaterBalance(int timeStep, DateTime datetime, double waterInput, double snowCoverFraction, double dryPeriod);
...
class DistributedHbv
{
 public:
  ...
  void WaterBalance(int timeStep, DateTime datetime, int initialTimeSteps, int numberTimeSteps) const;
  double GetPrecipitation() const;
  double GetTemperature() const;
  double GetLakeStorage() const;
  double GetLakeStorageChange() const;
